<div class="tbl">
    <div class="menu-tbl">
        ...
        <div class="menu-tbl_ menu-tbl-l">
          <a href="<?php echo $level.PAGES_AD;?>edit_qc2_slide.php"class="btn btn-them-moi" class="btn btn-primary" >
                <span id="btn_add">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo date("d-m-Y",strtotime($getSlide['ngay_bat_dau']))?></td>
                    <td><?php echo date("d-m-Y",strtotime($getSlide['ngay_ket_thuc']))?></td>
                    <td>
                    ...
                    <td>
                        <a href="<?php echo $level.PAGES_AD.'edit_qc2_slide.php?id='.$getSlide['id']?>">
